      ...
      fetch(`${auth_store.backend_url}/api/v1/request_book`, {
        ...
        if (response.ok) {
          response.json().then(data => {
            ...
            // Optionally, you can refresh the list or navigate away
              ...
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group" v-if = "auth_store.role ==='librarian' " >
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="#" @click.prevent="deleteBook(section_name, book.book_id)">Delete Book</a></li>
                    <li><RouterLink class="dropdown-item" :to="{ path: '/edit_book', query: { bookId: book.book_id } }">Edit Book</RouterLink></li>
                  </ul>
                </div>
